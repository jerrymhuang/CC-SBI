...
def main():
    ...
    dm_workflow = bf.workflows.BasicWorkflow(
        ...
        checkpoint_filepath=checkpoint_dir / "h_atom_diffusion.ckpt",
    )
    ...
    try:
        ...
        model_path = checkpoint_dir / "h_atom_diffusion.ckpt" / "model.keras"
        ...
        for plot_name, fig in figures.items():
            fig_path = figures_dir / f"h_atom_{args.num_molecules}_{plot_name}.png"
